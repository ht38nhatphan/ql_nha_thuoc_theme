                        ...
                        <form>
                            ...
                            <div className="input-group nm-gp">
                                <div className="form-check">
                                    ...
                                    <label className="form-check-label nm-check" htmlFor="rememberMe">Keep me logged in</label>
                                </div>
                            </div>
                            <div className="row nm-aic nm-mb-1">
                                ...
                                <div className="col-sm-6 nm-sm-tr">
                                    <a className="nm-fs-1 nm-fw-bd" href="recover.html">Forgot Password?</a>
                                </div>
                            </div>
                            <footer style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.75rem', color: '#97a4af', fontWeight: 400 }}>
                                Don't have an account? <a className="nm-fs-1 nm-fw-bd" style={{ fontSize: '0.75rem' }} href="signup">Signup</a></footer>
                        </form>
                    </div>
                </div>
            </main>
